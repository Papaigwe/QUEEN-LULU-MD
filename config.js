...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Qᴜᴇᴇɴ lulu",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐐𝐮𝐞𝐞𝐧 lulu 𝐁𝐨𝐭",
    ...
    ownernumber: process.env.Owner_Number || "24160338758",
    instagramId: process.env.Insta || "igwetech",

    /**
     * other details and parameters
     */
    author: process.env.Author || "𝐏𝐢𝐤𝐚𝐁𝐨𝐭𝐳 🌚🌙",
    packname: process.env.PackName || "𝕼𝖚𝖊𝖊𝖓 lulu 𝕾𝖙𝖎𝖈𝖐𝖊𝖗 𝕻𝖆𝖈𝖐 🪀",
    socialLink: process.env.Web || "https://github.com/papaigwe",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/E490r0wSpSr89XkCWe",
    ...
    imageUrl: "https://i.imgur.com/q6Gdcum.jpeg", // image url, to replace to your url upload your image to https://imgbb.com
    imageMentionUrl: "https://i.imgur.com/q6Gdcum.jpeg", // image for mention reply audio media
